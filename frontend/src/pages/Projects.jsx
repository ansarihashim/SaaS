  ...
  return (
    <DashboardLayout>
      <Topbar
        ...
        action={
          canCreateProject && (
            <button className="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 hover:shadow-md active:scale-95 transition-all duration-200 flex items-center gap-2">
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
      ...
      {!loading && !error && projects.length === 0 && (
        <div className="text-center py-16">
          ...
          {canCreateProject && (
            <button className="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 hover:shadow-md active:scale-95 transition-all duration-200">
...
function ProjectCard({ project }) {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg hover:border-purple-300 hover:-translate-y-1 transition-all duration-200 cursor-pointer">
      {/* Project Header */}
